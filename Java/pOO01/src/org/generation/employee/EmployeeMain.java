...
public class EmployeeMain {
    public static void main(String[] args) {
        ...
        Employee orlando = new Employee("Orlando", "Lopez", 29, 10855.50f, "Java Dev");
        System.out.println(orlando);

        Employee ale = new Employee("Alejandra", "Moreno", 24, 21558.27f, "Java Dev");
        System.out.println(ale);

        //Invocando metodos de comportamiento
        orlando.trabajar();
        ale.calcularSalario();
        daniel.infoGeneral();
        ale.infoGeneral();
        ...
        System.out.println(ale.getNombre() + "gana $" + ale.getSalario() + "en la posicion " + ale.getPuesto());

        System.out.println(orlando.getNombre() + "gana $" + orlando.getSalario() + "y se le aumentan $2000 quedando en $" + (orlando.getSalario() + 2000));

        orlando.calcularSalario(); //El salario no se modifico ya que solo se realizo una operacion matematica con base en el salario
        ...
        orlando.calcularSalario(); //Ya se muesta el nuevo salario como parte del dato de la variable de instancia del objeto Orlando
    }
}
